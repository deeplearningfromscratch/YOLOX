...
def make_parser():
    ...
    parser.add_argument("--onnx-input", type=str, default=None, help="model name")
    parser.add_argument("--calibration_data", type=str, default=None, help="calibration")
    # distributed
...
def main(exp, args, num_gpu):
    ...
    cal_img_list = [str(path.name) for path in Path("mscoco_calibration").glob("*.jpg")]
    loader = exp.get_cal_loader(args.batch_size, is_distributed, args.test, args.legacy, cal_img_list)
